...
/*--------------------------------------------------------------------*\
|- Function:	 void CenterString(char *buffer,int l)		      -|
|-								      -|
|- Description:  Center the string in a string of length l	      -|
|-								      -|
|- Input:	 buffer: the initial string			      -|
|-		 l: length of the destination buffer		      -|
|-								      -|
|- Return:	 nothing					      -|
|-								      -|
|- Notes:	 The buffer have to be l+1 lenght		      -|
\*--------------------------------------------------------------------*/

void CenterString(char *buffer,int length);
