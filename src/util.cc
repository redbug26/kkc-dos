...
void MenuCreat(char* titbuf, char* buf, char* path) {
    ...
    int n;
    char buffer[256], buf2[256], enter[80];
...
void PcTeam(void) {
    ...
    bar[0].Titre = "Demos ludiques";
    bar[0].Help = 500;
    bar[1].Titre = "Demos utilitaires";
    bar[1].Help = 500;
    bar[2].Titre = "Jeux sharewares";
    bar[2].Help = 500;
    bar[3].Titre = "Utils shareware";
    bar[3].Help = 500;
    bar[4].Titre = "Demos, images et sons";
    bar[4].Help = 500;
    bar[5].Titre = "Divers";
    bar[5].Help = 500;
